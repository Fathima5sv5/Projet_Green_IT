...
const cartItems = ref([
  { id: 1, name: 'Gold Earrings', description: 'Elegant gold earrings', price: 150, quantity: 2, image: '../../public/img/jewellery_image2.jpg' },
  { id: 2, name: 'Necklace', description: 'Original green necklace', price: 100, quantity: 1, image: '../../public/img/jewellery_image5.jpg' },
])
...
const updateCart = (index) => {
  cartItems.value[index].price = cartItems.value[index].price
}
