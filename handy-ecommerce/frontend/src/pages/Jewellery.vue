      ...
      <section class="intro-hero-container">
        ...
        <div class="hero">
          <div class="hero-image">
            <img src="/img/jewellery_image1.jpg" alt="Potter at work" />
          </div>
        </div>
      </section>
...
const items = [
  {
    ...
    name: 'GOLD EARINGS',
    price: 375,
    image: '/img/jewellery_image2.jpg'
  },
  {
    country: 'Hawaii',
    name: 'HAWAIIAN HEIRLOOM',
    price: 1250,
    image: '/img/jewellery_image3.jpg'
  },
  {
    country: 'PORTUGAL',
    name: 'FAULTY EARRINGS',
    price: 45,
    image: '/img/jewellery_image4.jpg'
  },
  {
    country: 'China',
    name: 'GOLD AND JADE NECKLACE',
    price: 3764,
    image: '/img/jewellery_image5.jpg'
  }
]
</script>
...
.intro-hero-container {
  ...
  background-color: #b7bfaa; /* Optionnel : couleur de fond pour renforcer la distinction */
}
...
.hero {
  ...
  background-color: #b7bfaa; /* Couleur d'arrière-plan pour la section hero */
  color: white;
}
